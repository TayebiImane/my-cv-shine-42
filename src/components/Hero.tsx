      ...
      <div className="container mx-auto px-6 py-20">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8 animate-slide-in">
            <div>
              <h2 className="text-lg text-primary mb-2 animate-pulse-glow">Hello, I'm</h2>
            ...
            <div className="flex gap-4">
              <Button 
                size="lg" 
                className="bg-gradient-primary hover:scale-105 transition-bounce glow"
          ...
          <div className="flex justify-center md:justify-end">
            <div className="relative">
              ...
              <img 
                ...
                className="relative w-80 h-80 md:w-96 md:h-96 object-cover rounded-full border-4 border-primary glow animate-float"
              />
            </div>
          </div>
        </div>
